...
class UserController {
    ...
    static async updateProfile(req, res) {
        ...
        try {
            ...
            if (profileImage) {
                ...
                imagePath = `data/user/0/com.example.untitled8/cache/cecd842f-dfd3-403c-b5e6-9448b2209212/${profileImage.originalname}`; // عدل المسار حسب الحاجة
    ...
    static async updateProfiles(req, res) {
        const { email, first_name, last_name, phone, address } = req.body;
        let profilePicturePath = req.file ? `data/user/0/com.example.untitled8/cache/cecd842f-dfd3-403c-b5e6-9448b2209212/${req.file.filename}` : null; // مسار الصورة إذا كانت موجودة
    ...
    static async getCommentsByFoodId(req, res) {
        ...
        try {
            ...
            if (comments.length > 0) {
                ...
                res.status(404).json({ success: false, message: 'No comments found for this food item.' });
            }
        } catch (error) {
